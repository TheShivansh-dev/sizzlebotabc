...
async def select_top_10_users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for idx, (user_id, username, score,round) in enumerate(top_10, 1):
        message += f"User: @{escape_markdown(str(username))} \nScore: {escape_markdown(str(score))} \nRounds: {round} \n"
    try:
...
async def my_rank(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for rank, (u_id, u_name, score,round) in enumerate(scores, 1):
        print(u_id,'is',u_name,"this is",user_id)
...
async def start_game_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        print('this is ',chat_id)
        if chat_id not in ALLOWED_GROUP_IDS:
            try:
                await update.message.reply_text("To Start This Quiz In Your Chat or Group Talk to My Sizzling Owner @V_ale_n_cia and say thanks to me in later  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy")
            except (BadRequest, Forbidden, TimedOut) as e:
                await update.message.chat.send_message("To Start This Quiz In Your Chat or Group Talk to My Sizzling Owner @V_ale_n_cia and say thanks to me in later  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy  or Join  ABCDYGH Academy")
            return
